...
function InfoSection({ ipInfo }: { ipInfo: ipGeolocation }) {
    return (<>
        <section className="flex flex-col max-w-400 mx-auto gap-3 bg-white rounded-2xl text-black py-7 shadow-xl px-10 md:grid md:grid-cols-4 md:py-15 md:divide-x md:divide-dark-gray">
